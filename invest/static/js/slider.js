...
noUiSlider.create(slider, {
    ...
    tooltips: {
        to: function () {
            ...
            return result = (numb < 1000000) ? tooltip.textContent = 'Bronze' :
                (numb < 2350000) ? tooltip.textContent = 'Silver' :
                    (numb < 4900000) ? tooltip.textContent = 'Gold' :
                        (numb >= 4900000) ? tooltip.textContent = 'Diamond' : '';
...
slider.noUiSlider.on('update', function (values, handle) {
    ...
    let result = (values[handle] < 1000000) ? color('c-50', 118, '#A37A60', values[handle]) :
        (values[handle] < 2350000) ? color('c-150', 120, '#96A6B9', values[handle]) :
            (values[handle] < 4900000) ? color('c-250', 122, '#DFBA4B', values[handle]) :
                (values[handle] >= 4900000) ? color('c-500', 125, '#6B9FE0', values[handle]) : ''
});
